/* ===========================================================================
   store.js · estado compartido (singleton) y mapas de columnas
   =========================================================================== */
export const store = {
  fileName: '',
  WB: {},        // { hoja: [filas...] }
  ROLE: {},      // { sug, fac, cons, ... : nombreHoja }
  RF: null,      // índices de Resumen_Fac
  BO: [],        // sugerencias agrupadas
  CURMES: '',    // mes corriente (máx de Resumen_Fac)
};
